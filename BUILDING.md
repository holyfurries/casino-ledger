...
dotnet build CasinoLedger.csproj --configuration Release "-p:MelonLoaderDir=$loader"
...
`MelonLoaderDir=/path/to/profile/MelonLoader dotnet format CasinoLedger.csproj`
...
CI packages `package/CasinoLedger.dll`; it does not compile the mod or need game
...
3. Commit and push the source, metadata and refreshed `package/CasinoLedger.dll`.
